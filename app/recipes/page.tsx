    ...
    return (
      <main className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center pt-32">
          <h1 className="text-4xl font-serif font-bold mb-4">No Recipes Found</h1>
          <p className="text-muted-foreground mb-8 text-lg">Check back later for new delicious recipes!</p>
          <Link 
            href="/"
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-32">
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground mt-4 text-lg">
            Explore our complete collection of {allRecipes.length} traditional Dawoodi Bohra recipes.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {allRecipes.map((recipe) => (
            <Link key={recipe.id} href={`/recipes/${recipe.slug}`} className="group block">
              <div className="relative rounded-2xl overflow-hidden bg-card border border-border transition-all hover:border-accent/50 hover:shadow-xl hover:-translate-y-1 h-full flex flex-col">
